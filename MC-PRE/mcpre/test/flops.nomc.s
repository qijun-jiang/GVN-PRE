...
.LBB0_4:                                # %for.body
	...
	vmulsd	E3(%rip), %xmm1, %xmm2
	vaddsd	E2(%rip), %xmm2, %xmm2
...
.LBB0_5:                                # %for.end
	...
	vmovsd	%xmm0, sa(%rip)
	cmpq	$512000000, %r14        # imm = 0x1E848000
	je	.LBB0_6
# BB#2:                                 # %while.cond
                                        #   in Loop: Header=BB0_3 Depth=1
...
.LBB0_17:
	...
	vxorps	%xmm4, %xmm4, %xmm4
.LBB0_20:                               # %for.end104
	vmovsd	%xmm4, -40(%rbp)        # 8-byte Spill
	vmovsd	%xmm6, -32(%rbp)        # 8-byte Spill
	vmovsd	%xmm7, -24(%rbp)        # 8-byte Spill
	movl	$TimeArray, %edi
	callq	dtime
	vmovsd	T+8(%rip), %xmm0
	vmulsd	TimeArray+8(%rip), %xmm0, %xmm0
...
.LBB0_23:                               # %for.end155
	...
	testq	%rbx, %rbx
	vmovsd	-32(%rbp), %xmm0        # 8-byte Reload
	vdivsd	-24(%rbp), %xmm0, %xmm3 # 8-byte Folded Reload
	jle	.LBB0_24
# BB#25:
	movl	$1, %eax
...
.LBB0_30:                               # %for.end300
	...
	testq	%rbx, %rbx
	vmovsd	-32(%rbp), %xmm0        # 8-byte Reload
	vdivsd	-24(%rbp), %xmm0, %xmm6 # 8-byte Folded Reload
	jle	.LBB0_31
# BB#32:
	movl	$1, %eax
...
.LBB0_34:                               # %for.end384
	...
	movl	$TimeArray, %edi
	vmovsd	%xmm6, -24(%rbp)        # 8-byte Spill
	callq	dtime
	vmovsd	T+8(%rip), %xmm0
	vmulsd	TimeArray+8(%rip), %xmm0, %xmm0
	vsubsd	nulltime(%rip), %xmm0, %xmm0
...
.LBB0_40:                               # %for.body490
	...
	vmulsd	%xmm4, %xmm1, %xmm4
	cmpq	%rax, %rcx
	vaddsd	B3(%rip), %xmm3, %xmm3
	vmulsd	%xmm3, %xmm1, %xmm3
	vaddsd	A3(%rip), %xmm4, %xmm4
	vmulsd	%xmm4, %xmm1, %xmm4
	vaddsd	A2(%rip), %xmm4, %xmm4
	vmulsd	%xmm4, %xmm1, %xmm4
	vaddsd	A1(%rip), %xmm4, %xmm4
	vmulsd	%xmm4, %xmm1, %xmm4
	vaddsd	%xmm4, %xmm2, %xmm4
	vaddsd	B2(%rip), %xmm3, %xmm3
	vmulsd	%xmm3, %xmm1, %xmm3
	vaddsd	B1(%rip), %xmm3, %xmm3
	vmulsd	%xmm3, %xmm1, %xmm1
	vaddsd	%xmm1, %xmm2, %xmm1
