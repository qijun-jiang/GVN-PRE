...
if.then6.split:                                   ; preds = %if.then6
  %ni9 = add i64 %sub, 4234234234234234
  br label %if.end
...
if.else.split:                                    ; preds = %if.else
  %ni6 = add i64 %add, 4234234234234234
  br label %if.end

if.end:                                           ; preds = %if.else.split, %if.then6.split
  %a.2 = phi i64 [ %sub, %if.then6.split ], [ %add, %if.else.split ]
  %stackVar.0 = phi i64 [ %ni9, %if.then6.split ], [ %ni6, %if.else.split ]
  br label %if.end9

if.else7:                                         ; preds = %for.body3
  %ni = add i64 %a.1, 4234234234234234
  br label %if.else7.split

if.else7.split:                                   ; preds = %if.else7
  br label %if.end9

if.end9:                                          ; preds = %if.else7.split, %if.end
  %a.3 = phi i64 [ %a.2, %if.end ], [ %a.1, %if.else7.split ]
  %stackVar.1 = phi i64 [ %stackVar.0, %if.end ], [ %ni, %if.else7.split ]
